...
*Language-specific instructions*: In both R and Python, save the model as `m2`. In R, use the `msummary()` function from the **modelsummary** package to display the results with the `stars = TRUE` option.
...
*Language-specific instructions*: In both R and Python, save the model as `m5`. In R, use the `msummary()` function from the **modelsummary** package to display the results with the `stars = TRUE` option.
...
*Language-specific instructions*: In both R and Python, save the model as `m6`. In R, use the `msummary()` function from the **modelsummary** package to display the results with the `stars = TRUE` option.
...
*Language-specific instructions*: In both R and Python, save the model as `m7`, and `m7b` if you rerun with robust standard errors. 
...
*Language-specific instructions*: In Python and R, store the model as `m8`. In R, use the `msummary()` function from the **modelsummary** package to display the results with the `stars = TRUE` option. 
